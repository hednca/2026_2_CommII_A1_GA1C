...
import Implementacion_Bloque_Promedios_De_Tiempos_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class Implementacion_Bloque_Promedios_De_Tiempos(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Implementacion_Bloque_Promedios_De_Tiempos")
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((3, 8, 1, 6, 10, 2, 7, 4, 9, 5), True, 1, [])
...
def main(top_block_cls=Implementacion_Bloque_Promedios_De_Tiempos, options=None):

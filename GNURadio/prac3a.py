...
class prac3a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_unpack_k_bits_bb_0 = blocks.unpack_k_bits_bb(32)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Engineering\\Projects\\Signal_Processing\\Comunicaciones 2 - 2026 - 2\\Git_Comunicaciones_2\\2026_2_CommII_A1_GA1C\\GNURadio\\sonido.wav', True, 0, 0)
